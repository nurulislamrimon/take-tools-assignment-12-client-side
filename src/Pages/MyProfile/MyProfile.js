    ...
    return (
        <section className='relative h-[calc(100vh-115px)] overflow-auto'>
            ...
            <div className='w-2/4 mx-auto grid gap-5 justify-center text-xl'>
                ...
                {userInfo?.phoneNumber && <div className="flex items-start justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 mr-1">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
                    </svg>
                    <p>{userInfo?.phoneNumber}</p>
                </div>}
                {userInfo?.education && <div className="flex items-start justify-center">
                ...
                {userInfo?.linkdin && <div className="flex items-center justify-center">
                    <svg viewBox="0 0 512 512" className='h-6 w-6 mr-1 rounded-full border' >
                        <path d="M186.4 142.4c0 19-15.3 34.5-34.2 34.5 -18.9 0-34.2-15.4-34.2-34.5 0-19 15.3-34.5 34.2-34.5C171.1 107.9 186.4 123.4 186.4 142.4zM181.4 201.3h-57.8V388.1h57.8V201.3zM273.8 201.3h-55.4V388.1h55.4c0 0 0-69.3 0-98 0-26.3 12.1-41.9 35.2-41.9 21.3 0 31.5 15 31.5 41.9 0 26.9 0 98 0 98h57.5c0 0 0-68.2 0-118.3 0-50-28.3-74.2-68-74.2 -39.6 0-56.3 30.9-56.3 30.9v-25.2H273.8z" />
                    </svg>
                    <p>{userInfo?.linkdin}</p>
                </div>}
                {userInfo?.address && <div className="flex items-start justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 mr-1">
