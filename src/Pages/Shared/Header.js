...
const Header = () => {
    ...
    const menus = [
        ...
        <CustomLink to='/addProduct' key='addProduct' className='p-3 btn btn-ghost'>Add Product</CustomLink>,
        user?.uid ?
        ...
        <header>
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    ...
                    <Link to='/' className="uppercase text-2xl font-semibold ml-4 font-title">Take Tools</Link>
                </div>
